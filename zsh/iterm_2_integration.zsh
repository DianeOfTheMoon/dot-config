...
alias imgcat=~/.local/share/iterm2/imgcat;alias imgls=~/.local/share/iterm2/imgls;alias it2api=~/.local/share/iterm2/it2api;alias it2attention=~/.local/share/iterm2/it2attention;alias it2check=~/.local/share/iterm2/it2check;alias it2copy=~/.local/share/iterm2/it2copy;alias it2dl=~/.local/share/iterm2/it2dl;alias it2getvar=~/.local/share/iterm2/it2getvar;alias it2git=~/.local/share/iterm2/it2git;alias it2setcolor=~/.local/share/iterm2/it2setcolor;alias it2setkeylabel=~/.local/share/iterm2/it2setkeylabel;alias it2ul=~/.local/share/iterm2/it2ul;alias it2universion=~/.local/share/iterm2/it2universion
